...
public class AutoUpdateTask extends AsyncTask<Long, Void, String> {
    ...
    private final static String GET_BUNDLE_URL = "https://upd.appery.io/update/9e4d469c-1d72-4d49-a000-b640742f81eb.zip";

    private static final Long BUILD_TIMESTAMP_MILLISEC = 1484133132 * 1000L;
